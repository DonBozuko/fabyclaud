...
Cohesion: 0.09
Nodes (39): ref_node_assert_strict, ref_node_test, AplicativoLocal, aplicativoLocalParaPedido(), auditarArquivos(), base(), classificarPedido(), classificarPedidoLovable() (+31 more)
...
Cohesion: 0.10
Nodes (28): EXT_ZIP, GithubSecao(), Props, baixarArquivos(), deBase64(), enviarArquivos(), EXT_CLONAR, EXT_TEXTO (+20 more)
...
### Community 14 - "orquestracao.server.ts"
Cohesion: 0.12
...
Cohesion: 0.13
Nodes (18): AGENTES_PRONTOS, Anexo, ContratoEntrega, EtapaOrquestracao, EXTENSOES_IMAGEM, EXTENSOES_TEXTO, LIMITE_CHARS_ARQUIVO, MEMORIA_SUGERIDA (+10 more)
...
Cohesion: 0.17
Nodes (28): selecionarMelhorModeloEtapa(), anexoSchema, apagarArquivo, cacheAgentes, cachePrompts, carregarProjetoCompleto(), criarBackup, enviarMensagem (+20 more)

### Community 24 - "evolucao.server.ts"
Cohesion: 0.19
Nodes (15): ehArquivoDeServidor(), pedidoExigeAutenticacaoPrivada(), problemasCriticos(), problemasDeAutenticacao(), problemasDeBanco(), afirmacoesSemProva(), Avaliacao, avaliarEntrega() (+7 more)
...
Cohesion: 0.09
Nodes (21): Backups(), Docs(), Props, TITULOS, createSupabaseAdminClient(), createSupabaseFetch(), isNewSupabaseApiKey(), supabaseAdmin (+13 more)
...
Cohesion: 0.12
Nodes (19): sonner, @tanstack/react-query, @tanstack/react-start, PainelNome, PainelRecursos(), descreverAuditoria(), injetarAuditorDeCliques(), ResultadoAuditoria (+11 more)
...
Cohesion: 0.12
Nodes (30): ref_node_fs, ref_node_path, ProvedorCustom, listarProvedoresCustom, obterMemoria, apagarChaveArmazenada(), apagarGithubContaArmazenada(), apagarProjetoArmazenado() (+22 more)
...
### Community 70 - "dados.$projeto.$colecao.ts"
Cohesion: 0.32
...
- **Why does `react` connect `react` to `package.json`, `cn`, `sidebar.tsx`, `github.functions.ts`, `auth.tsx`, `class-variance-authority`, `pagination.tsx`, `navigation-menu.tsx`, `command.tsx`, `menubar.tsx`, `form.tsx`, `carousel.tsx`, `drawer.tsx`, `chart.tsx`, `breadcrumb.tsx`, `client.server.ts`, `index.tsx`, `lucide-react`, `__root.tsx`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `@tanstack/react-start` connect `index.tsx` to `package.json`, `client.server.ts`, `github.functions.ts`, `auth.tsx`, `server.ts`, `faby.functions.ts`?**
