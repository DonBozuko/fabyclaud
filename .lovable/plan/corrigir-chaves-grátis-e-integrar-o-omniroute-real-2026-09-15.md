...
Fazer o FabyClaud usar somente as opções gratuitas corretas, sem confundir o OmniRoute local com serviços pagos.
...
- Mostrar nas configurações o comando obrigatório do terminal:
  ...
  - `omniroute`
- Explicar no próprio sistema que o painel abre em `localhost:20128`, onde o usuário conecta provedores gratuitos e cria sua chave.
- Usar o roteamento `auto/coding`, para o OmniRoute escolher a melhor IA gratuita disponível para programação.
